...
func MountRoutes(router gin.IRouter, authenticator httpauth.Authenticator, handler *Handler) {
	...
	public.Use(authenticator.Authenticate())
	{
		...
		public.PUT("/v1/environments/:environment_id", handler.UpdateEnvironment)
		...
		public.PUT("/v1/sessions/:session_id", handler.UpdateSession)
		...
		public.PUT("/v1/sessions/:session_id/resources/:resource_id", handler.UpdateSessionResource)
		...
		public.PUT("/v1/agents/:agent_id", handler.UpdateAgent)
		...
		public.PUT("/v1/vaults/:vault_id", handler.UpdateVault)
		...
		public.PUT("/v1/vaults/:vault_id/credentials/:credential_id", handler.UpdateCredential)
